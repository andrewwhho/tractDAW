...
export const SAMPLE_CATALOG: SampleMetadata[] = [
  ...
  { id: 'kick_2', name: 'Kick 2', category: 'kicks', type: 'drum', url: '/audio/samples/drums/kicks/RS Kick 2.wav' },
  { id: 'kick_3', name: 'Kick 3', category: 'kicks', type: 'drum', url: '/audio/samples/drums/kicks/RS Kick 3.wav' },
];
